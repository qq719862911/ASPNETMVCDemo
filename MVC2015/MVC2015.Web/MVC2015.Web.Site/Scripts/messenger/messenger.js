  ...
  _Message = (function(_super) {
    ...
    _Message.prototype.update = function(opts) {
      ...
      if (this.options.hideAfter) {
        ...
        var actionAfterHide = this.options.actionAfterHide;
    ...
    _Message.prototype.template = function(opts) {
      var $action, $actions, $cancel, $link, $message, $text, action, _i, _len, _ref2,
        _this = this;
      $message = $("<div class='messenger-message message " + opts.type + " message-" + opts.type + " alert-" + opts.type + "'>");
      if (opts.showCloseButton) {
        ...
        $cancel.click(function () {          
            _this.cancel();
            if (opts.type == "info") {
                hideLoading();//hide loading background; success, error  dont have background
            }            
            return true;
        });
